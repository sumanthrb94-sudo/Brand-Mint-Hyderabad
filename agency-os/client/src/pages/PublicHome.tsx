...
const faqs = [
  ...
  ["What is outside the tiers?", "Marketplace integrations, multi-vendor functionality, multi-currency or multi-language, native React Native apps, photography/copywriting, ongoing marketing, and WhatsApp Business API or AI-chat automation are quoted separately if required. The manual WhatsApp order desk is included in the WhatsApp Store tier — it is the automation that costs extra, not the messaging."],
];
...
export default function PublicHome() {
  ...
  return <main className="public-home ecom-home min-h-screen overflow-x-hidden bg-[#f7f1e6] text-[#12362a]">
    ...
    <header className="public-nav ecom-nav">
      {/* The city is set INSIDE the BrandMark SVG, under the wordmark's rule,
          and its aria-label already reads "Brand Mint Studios, Hyderabad".
          A sibling <span>Hyderabad</span> printed it a second time, so the
          mobile header read "BRAND MINT — HYDERABAD | HYDERABAD". Removed
          here rather than from the SVG: in the SVG it is part of the logo
          lockup, tied to the rule; as a span it was a loose repeat. */}
      <Link href="/" className="public-brand" aria-label="Brand Mint home"><BrandMark /></Link>
