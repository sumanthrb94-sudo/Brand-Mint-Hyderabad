...
# vendored from msitarzewski/agency-agents@c89557f :: project-management/project-management-meeting-notes-specialist.md
# tools: line added here, not upstream. No Bash, no MCP — see tools/vendor-agents.mjs
---
