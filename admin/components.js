...
const NAV = [
  {
    ...
    items: [
      ...
      { id: "campaigns", label: "Campaigns", route: "#/campaigns", icon: iconSend() },
      { id: "analyticLeads", label: "Lead Analytics", route: "#/analyticLeads", icon: iconTrendingUp() },
...
function iconSend()    { return svg('<path d="M2 14l11.3-5.1c.3-.2.5-.6.5-.9s-.2-.7-.5-.9L2 2v4.5l8 1.5-8 1.5V14z"/>'); }
...
function iconTrendingUp() { return svg('<path d="M2 12l3.5-4 3 2.5L12 4M11 4h3v3" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/>'); }
