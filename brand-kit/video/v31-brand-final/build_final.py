"""
Brand Mint Studios — Brand Story Ident (v31 / final flow)
...
OUT_DIR = HERE / "out"
OUT_MP4 = OUT_DIR / "brandmint-final-60fps.mp4"
...
def main():
    print(f"v31 final · {FPS}fps · {TOTAL_S}s · {N_PARTICLES} dots · 4 anchor + 392 to M")
    render_all_frames()
    mux()
