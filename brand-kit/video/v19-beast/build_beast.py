"""
BrandMint Studios — v19 BEAST · MrBeast-style retention design · ~15s @ 60fps.

This breaks the editorial restraint of v13-v18. Per CEO request, full
MrBeast aesthetic: high-contrast YELLOW + RED + WHITE, 8px black strokes,
mega-bold typography, bright color blocks, arrows + circle annotations,
stat callouts, zoom-punches, fast cuts.

Brand Mint identity preserved minimally: Plus Jakarta Sans typeface,
mint frame only at the brand reveal (the rest is pure beast).

Content arc (MrBeast structure):
  0:00-0:02  HOOK     "I ranked Hyderabad's 13 biggest builders"
  0:02-0:04  STAKES   "Worth ₹2,40,000 crores"
  0:04-0:07  METHOD   "4 episodes. Zero interviews. Public records only."
  0:07-0:10  WINNER   "#1 is PRESTIGE GROUP" (with circle annotation)
  0:10-0:13  RECAP    "EP01-04 streaming now"
  0:13-0:15  CTA      "Comment 'EMPIRES'"

Run: python3 build_beast.py
"""
...
BEAST_BLACK = "#0A0A0A"
BEAST_WHITE = "#FFFFFF"
BEAST_YELLOW = "#FFE100"       # The MrBeast yellow
BEAST_RED = "#E83232"          # Bright red for arrows + emphasis
BEAST_BLUE = "#1B6BFF"         # Accent blue for stat blocks
BEAST_GREEN = "#22C55E"        # Money green
BEAST_PINK = "#FF3D8B"

# Brand Mint anchor (used only on brand frame)
MINT = "#10B981"
MINT_2 = "#7CF6C8"
INK_2 = "#10171a"
